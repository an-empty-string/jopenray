					...
					if (s == null) {
						...
						client.getWriter().sendImage(
								MessageImage.createImage(
										client.getSerialNumber() + " : " + client.getCardId(), 1280, 1024, Color.BLACK), 0, 0);
						//client.getWriter().sendImage(ImageIO.read(new File("nosessions.png")), client.getScreenWidth(), client.getScreenHeight());
